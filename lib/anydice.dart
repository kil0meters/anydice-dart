...
typedef ProbabilityDistribution = List<List<double>>;
...
class AnyDiceWrapper {
  ...
  static Future<ProbabilityDistribution> roll(String diceExpression) async {
...
int generateRandomValue(ProbabilityDistribution probabilityDistribution) {
  var rng = Random();
